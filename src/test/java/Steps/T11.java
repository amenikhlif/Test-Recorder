...
@When("User clic in select has xpath {string} and Value as {string}")
public void user_clic_in_select_has_xpath(String string,String string2)  
{
	Select a = new Select(driver.findElement(By.xpath(string)));
    a.selectByValue(string2);
}
