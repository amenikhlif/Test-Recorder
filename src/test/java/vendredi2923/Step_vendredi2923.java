...
public class Step_vendredi2923 {
...
@When("User clic in input radio has xpath {string}")
public void user_clic_in_input_radio_has_xpath(String string) {
	driver.findElement(By.xpath(string)).click();
}
